 ...
 */
function activitycustomfieldsreport_civicrm_xmlMenu(&$files) {
  _activitycustomfieldsreport_civix_civicrm_xmlMenu($files);
}
 ...
 */
function activitycustomfieldsreport_civicrm_managed(&$entities) {
  _activitycustomfieldsreport_civix_civicrm_managed($entities);
}
 ...
 */
function activitycustomfieldsreport_civicrm_caseTypes(&$caseTypes) {
  _activitycustomfieldsreport_civix_civicrm_caseTypes($caseTypes);
}
 ...
 */
function activitycustomfieldsreport_civicrm_angularModules(&$angularModules) {
  _activitycustomfieldsreport_civix_civicrm_angularModules($angularModules);
}
 ...
 */
function activitycustomfieldsreport_civicrm_alterSettingsFolders(&$metaDataFolders = NULL) {
  _activitycustomfieldsreport_civix_civicrm_alterSettingsFolders($metaDataFolders);
}
 ...
 *
function activitycustomfieldsreport_civicrm_preProcess($formName, &$form) {
